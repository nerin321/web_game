    ...
    <section className="border-secondry text-primary pt-14 grid grid-cols-3 gap-6 pb-4 mt-12 border-t-4">
      <div className="space-y-6">
        ...
        <p className="text-xl">
          ...
          : Chúng tôi chỉ có 2 website này là website Tải Game Việt Hóa Miễn Phí
          Tốc độ cao mới nhất , Full Kích Hoạt , Full DLC , Full Mods … chia sẻ
          những thủ thuật về game và công nghệ . Không liên quan đến bất kỳ
          website khác.
        </p>
        <p className="text-xl">
          Ngoài ra{" "}
        ...
        <p className="text-xl">
          ...
          là website độc lập hoàn toàn không có liên quan đến bất kỳ một website
          nào khác . Chúng tôi là một website riêng biệt . Chúng tôi với quan
          niệm sẽ là một cộng đồng sạch sẽ , ko toxic , là một nơi chia sẻ hỗ
          trợ tận tâm nhất
        </p>
      </div>
      <div>
